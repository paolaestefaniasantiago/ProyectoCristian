...
let Ans = 0;
  function showResults() {	
	...
	var numW= numWrong;
        ...
        type: "GET",
        success : function(){
                document.location.href = "validauser2.php?numW="+numW+"&numC="+numC;
		}
		});
  ...
  const myQuestions = [
	...
	
	{
      ...
      answers: {
        ...
        b: "frecuentemente sé cuáles son las soluciones, pero luego tengo dificultad para imaginarme los pasos para llegar a ellas."
      },
      correctAnswer: "a"
    },
	...
	
	{
      ...
      answers: {
        ...
        b: "Ntrato de entender el todo antes de ir a los detalles."
      },
      correctAnswer: "a"
    },
